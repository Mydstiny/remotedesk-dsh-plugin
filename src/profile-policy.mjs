...
export function assertProfile(ctx,{requireLoader=false}={}){
 ...
 if(!loader)return;
 for(const entry of loader.entries())if(entry.options.name==='@deepseek-ai/dsh-agent-instructions')requireThat(entry.disabled,'DSH_GLOBAL_INSTRUCTIONS_MUST_BE_DISABLED');
}
